...
execute as @a[scores={Voidblock_structures_id=30..}] run scoreboard objectives add Voidblock_test_structures dummy
execute as @a[scores={Voidblock_structures_id=35..}] run scoreboard players add @a Voidblock_test_structures 1
scoreboard players add @a Voidblock_structures_id 1
...
execute as @a[scores={Voidblock_test_structures=6}] run effect give @a night_vision 71 0 true


##TELEPORT PLAYER IN THE STRUCTURES (AGGIUNGERE TUTTE LE STRUTTURE)

#Ocean Ruins
execute as @a[scores={Voidblock_test_structures=100}] run tp @a 488 45 -260 0 0

#Cherry Grove
execute as @a[scores={Voidblock_test_structures=200}] run tp @a -198 45 -485 0 0

#Trail Ruins
execute as @a[scores={Voidblock_test_structures=300}] run tp @a -266 45 -484 0 0

#Pillager Outpost
execute as @a[scores={Voidblock_test_structures=400}] run tp @a 500 45 55 0 0

#Village
execute as @a[scores={Voidblock_test_structures=500}] run tp @a 460 45 350 0 0

#Wolfs Pack
execute as @a[scores={Voidblock_test_structures=600}] run tp @a 570 44 350 0 0

#Swamp Hut
execute as @a[scores={Voidblock_test_structures=700}] run tp @a -180 45 -180 0 0

#Igloo
execute as @a[scores={Voidblock_test_structures=800}] run tp @a 180 45 180 0 0

#Jungle Pyramids
execute as @a[scores={Voidblock_test_structures=900}] run tp @a -60 45 500 0 0

#Desert Pyramid
execute as @a[scores={Voidblock_test_structures=1000}] run tp @a 60 45 -500 0 0

#Shipwrecks
execute as @a[scores={Voidblock_test_structures=1100}] run tp @a 280 45 0 0 0

#Stronghold
execute as @a[scores={Voidblock_test_structures=1200}] run tp @a 700 45 700 0 0

#Ancient City
execute as @a[scores={Voidblock_test_structures=1300}] run tp @a -700 45 -700 0 0
...
execute as @a[scores={Voidblock_test_structures=1500..5005}] run scoreboard players add @a Voidblock_final 1
scoreboard objectives add Voidblock_final dummy
...
execute as @a[scores={Voidblock_final=120}] run gamemode survival @a
execute as @a[scores={Voidblock_final=130}] run playsound minecraft:block.amethyst_cluster.break ambient @a 0 66 0 100 2
execute as @a[scores={Voidblock_final=140}] run scoreboard objectives remove Voidblock_level_dat


##Voidblock ID DELAY (AGGIORNARE SEMPRE QUANDO VENGONO AGGIUNTE NUOVE STRUTTURE. DELAY PID DELLA CONVERSIONE)
execute as @a[scores={Voidblock_final=350}] run scoreboard objectives add Voidblock_id dummy


##FUNCTION STRUCTURES LOOP
execute as @a[scores={Voidblock_test_structures=5000..}] run scoreboard players set @a Voidblock_final 100000
execute as @a[scores={Voidblock_structures_id=2000000..}] run scoreboard players set @a Voidblock_structures_id 10000
execute as @a[scores={Voidblock_test_structures=2000000..}] run scoreboard players set @a Voidblock_test_structures 10000