...
execute as @a[scores={Voidblock_islands=4}] run scoreboard objectives add Voidblock_very_small minecraft.custom:minecraft.play_time
execute as @a[scores={Voidblock_islands=4}] run tellraw @a {"translate":"skyblock_classic_edition.loading.chat"}
...
## Force Chunks
execute in minecraft:overworld as @a[scores={Voidblock_very_small=1..2}] run forceload add 25 1022 2 1003
execute in minecraft:the_nether as @a[scores={Voidblock_very_small=1..2}] run forceload add 4 4 4 4
execute as @a[scores={Voidblock_very_small=300..}] run forceload remove all
...
execute as @a[scores={Voidblock_very_small=150}] run scoreboard players set @a Voidblock_tp 1
execute as @a[scores={Voidblock_very_small=150..}] run scoreboard objectives add Voidblock_structures_id dummy
execute as @a[scores={Voidblock_very_small=300}] run spawnpoint @a -1 65 0
execute as @a[scores={Voidblock_very_small=300}] run weather clear 1000s
execute as @a[scores={Voidblock_very_small=300}] run scoreboard objectives add kills deathCount
execute as @a[scores={Voidblock_very_small=300}] run scoreboard objectives setdisplay list kills