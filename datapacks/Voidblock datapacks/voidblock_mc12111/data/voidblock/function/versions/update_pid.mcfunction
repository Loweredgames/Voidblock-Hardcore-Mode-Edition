...
###FUNCTION PID - PID_1_mc12111 - 1.21.11 (SPOSTARE "PID_X" IN LEGACY QUANDO FINISCE IL SUPPORTO DELLA VERSIONE, NON ELIMINARE IL COMMENTO IN SE)
...
execute as @a[scores={PID_1_mc12111=212..1000},gamemode=spectator] run gamemode survival @a