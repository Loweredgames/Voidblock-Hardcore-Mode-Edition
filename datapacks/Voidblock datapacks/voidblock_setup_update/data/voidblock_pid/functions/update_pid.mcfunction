...
##SUBPID END (QUANDO FINISCE IL PID AGGIUNGERE IL SUBPID O IL PID MA SOLO NEL PRIMO SUBPID. GUARDARE SEMPRE LA SCORE ALLA FINE DELLA FUNZIONE, ANCHE NEL SUBPID DENTRO LA FUNZIONE)
#>execute as @a[scores={1.20.6_PID_0_1=1015..}] run scoreboard objectives add 1.20.6_PID_0_2 dummy (per il futuro)
...
#execute as @a[scores={Voidblock_final=351}] run scoreboard players set @a 1.20.6_PID_0 -250
