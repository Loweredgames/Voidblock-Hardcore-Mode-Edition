...
execute as @a[scores={PID_1_mc1215=-100..}] run scoreboard players set @a PID_0_mc1215 1
execute as @a[scores={PID_1_mc1215=-100..}] run scoreboard players set @a PID_0_mc1215 1
execute as @a[scores={PID_1_mc1215=-100..}] run scoreboard players set @a PID_0_mc1215 1
...
execute as @a[scores={PID_0_mc1215=1..}] run scoreboard players add @a PID_old_v1 1
execute as @a[scores={PID_0_mc1215=1..}] run scoreboard players add @a PID_old_v2 1
execute as @a[scores={PID_0_mc1215=1..}] run scoreboard players add @a PID_old_v3 1
...
execute as @a[scores={PID_old_v1=805..}] run scoreboard objectives remove PID_0_mc1215
execute as @a[scores={PID_old_v2=990..}] run scoreboard objectives remove PID_0_mc1215
execute as @a[scores={PID_old_v3=990..}] run scoreboard objectives remove PID_0_mc1215
...
execute as @a[scores={PID_1_mc1215=1000..}] run scoreboard objectives remove PID_old_v1
execute as @a[scores={PID_1_mc1215=1000..}] run scoreboard objectives remove PID_old_v2
execute as @a[scores={PID_1_mc1215=1000..}] run scoreboard objectives remove PID_old_v3


###FUNCTION PID OLD v1 - PID_0_mc1215 - 1.21.5 (NON RIMUOVERE IL COMMENTO IN SE)
...
execute as @a[scores={PID_old_v1=745}] run scoreboard objectives add PID_0_mc1215 dummy
...
execute as @a[scores={PID_old_v2=745}] run scoreboard objectives add PID_0_mc1215 dummy
...
execute as @a[scores={PID_0_mc1215=1..}] run scoreboard players set @a PID_1_mc1215 -100
execute as @a[scores={PID_0_mc1215=1..}] run scoreboard players set @a PID_1_mc1215 -100
execute as @a[scores={PID_0_mc1215=1..}] run scoreboard players set @a PID_1_mc1215 -100
