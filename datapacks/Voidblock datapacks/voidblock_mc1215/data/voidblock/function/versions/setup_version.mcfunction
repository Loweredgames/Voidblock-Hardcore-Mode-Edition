...
execute as @a[scores={Voidblock_install=1..}] run scoreboard players set @a PID_1_mc1215 -10000
execute as @a[scores={Voidblock_multiplayer_join=2}] run scoreboard players set @a PID_1_mc1215 24000
...
#execute as @a[scores={PID_1_mc1215=30}] run tellraw @s {"translate":"skyblock_classic_edition.versions_id.warning_update.on","italic":true,"color":"#d5d5d5"}
execute as @a[scores={PID_1_mc1215=30}] run tellraw @s {"translate":"skyblock_classic_edition.versions_id.warning_update.off","italic":true,"color":"#d5d5d5"}
