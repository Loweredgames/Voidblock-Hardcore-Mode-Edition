...
#execute as @a[scores={PVN_0_mc12111=6}] run tellraw @s ["",{"color":"red","translate":"skyblock_classic_edition.version_update.development_mc_version"}]
