...
##SUBPID END (QUANDO FINISCE IL PID AGGIUNGERE IL SUBPID O IL PID MA SOLO NEL PRIMO SUBPID. GUARDARE SEMPRE LA SCORE ALLA FINE DELLA FUNZIONE, ANCHE NEL SUBPID DENTRO LA FUNZIONE. DISABILITA SE NON C'È NESSUN SUBPID)
#>execute as @a[scores={SUBPID_1_mc12110=1015..}] run scoreboard objectives add SUBPID_2_mc1219 dummy (aggiungere per il futuro il 2)
...
#scoreboard players add @a SUBPID_2_mc1219 1
...
###FUNCTION PID - PID_1_mc12110 - 1.21.7/1.21.8/1.21.9/1.21.10 (SPOSTARE "PID_X" IN LEGACY QUANDO FINISCE IL SUPPORTO DELLA VERSIONE, NON ELIMINARE IL COMMENTO IN SE)
