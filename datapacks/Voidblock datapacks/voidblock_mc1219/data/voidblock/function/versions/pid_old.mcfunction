...
execute as @a[scores={PID_0_mc1219=1..}] run scoreboard players add @a PID_old_v1 1
execute as @a[scores={PID_0_mc1219=1..}] run scoreboard players add @a PID_old_v2 1
execute as @a[scores={PID_0_mc1219=1..}] run scoreboard players add @a PID_old_v3 1
...
execute as @a[scores={PID_old_v1=805..}] run scoreboard objectives remove PID_0_mc1219
execute as @a[scores={PID_old_v2=990..}] run scoreboard objectives remove PID_0_mc1219
execute as @a[scores={PID_old_v3=990..}] run scoreboard objectives remove PID_0_mc1219
...
###FUNCTION PID OLD v1 - PID_0_mc1219 - 1.21.9/1.21.10 (NON RIMUOVERE IL COMMENTO IN SE)
...
execute as @a[scores={PID_old_v1=745}] run scoreboard objectives add PID_0_mc1219 dummy
execute as @a[scores={PID_old_v1=750}] run scoreboard objectives add PID_old dummy


###FUNCTION PID OLD v2 - PID_0_mc1219 - 1.21.9 (NON RIMUOVERE IL COMMENTO IN SE)
...
execute as @a[scores={PID_old_v2=745}] run scoreboard objectives add PID_0_mc1219 dummy
execute as @a[scores={PID_old_v2=750}] run scoreboard objectives add PID_old dummy


###FUNCTION PID OLD v3 - PID_0_mc1219 - 1.21.9/1.21.10 (NON RIMUOVERE IL COMMENTO IN SE)
