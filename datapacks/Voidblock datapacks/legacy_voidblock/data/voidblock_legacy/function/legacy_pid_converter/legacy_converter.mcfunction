...
execute as @a[scores={skyblock=1..}] run scoreboard players set @a Voidblock_islands 5
execute as @a[scores={skyblock=1..}] run effect give @a minecraft:slow_falling 180 0 false
...
execute as @a[scores={skyblock_large=140..}] run scoreboard players set @a Voidblock_islands 5
...
execute as @a[scores={skyblock_normal=140..}] run scoreboard players set @a Voidblock_islands 5
...
execute as @a[scores={skyblock_small=140..}] run scoreboard players set @a Voidblock_islands 5
...
execute as @a[scores={SkyblockCE_large=140..}] run scoreboard players set @a Voidblock_islands 5
...
execute as @a[scores={SkyblockCE_small=140..}] run scoreboard players set @a Voidblock_islands 5
...
execute as @a[scores={SkyblockCE_very_small=140..}] run scoreboard players set @a Voidblock_islands 5
