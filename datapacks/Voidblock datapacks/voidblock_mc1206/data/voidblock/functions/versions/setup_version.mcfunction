...
execute as @a[scores={Voidblock_install=1..}] run scoreboard players set @a 1.20.6_PID_0 -10000
execute as @a[scores={Voidblock_install_test=1..}] run scoreboard players set @a 1.20.6_PID_0 -10000
execute as @a[scores={Voidblock_multiplayer_join=2}] run scoreboard players set @a 1.20.6_PID_0 24000
