...
execute as @a[scores={Voidblock_id=10}] run scoreboard objectives remove 1.20.6_PVN_0
execute as @a[scores={Voidblock_import=20}] run scoreboard objectives remove 1.20.6_PVN_0
...
#execute as @a[scores={1.21.5_PVN_0=6}] run tellraw @s ["",{"color":"red","translate":"skyblock_classic_edition.version_update.development_mc_version"}]
